...
<html lang="en">
    ...
    ?>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="judul_film" name="judul_film" value="<?php echo $judul_film ?>">
        </div><br>
        <div class="form-group">
            <label for="tahun_rilis">Tahun Rilis:</label>
            <input type="date" class="form-control" id="tahun_rilis" name="tahun_rilis" value="<?php echo $tahun_rilis; ?>">
        <div class="form-group">
            <label for="sinopsis">Sinopsis:</label>
            <textarea class="form-control" id="sinopsis" name="sinopsis"><?php echo $sinopsis; ?></textarea>
        </div><br>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="nama_pemain" name="nama_pemain" value="<?php echo $nama_pemain ?>">
        </div><br>
        <div class="form-group">
